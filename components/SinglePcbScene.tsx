...
function PcbAssembly() {
  ...
  // Materials (using accent #A3E635, body #1f2937, pcb #0a8f4c)
  ...
  const chipMaterial = new THREE.MeshStandardMaterial({
    color: '#a1a1aa', // Slate 400 (simulating metallic chips)
    roughness: 0.1,
    metalness: 0.9,
  });
  ...
  // --- GEOMETRIES ---
  return (
    <group ref={assemblyRef} scale={1.0} rotation={[0.4, 0, 0]}> {/* Initial tilt for better view */}
      ...
      <mesh material={pcbMaterial} position={[0, 0, 0]}>
        ...
        {/* Simulated Chips / Components (on PCB) - FIX APPLIED HERE */}
        <mesh material={chipMaterial} position={[0, PCBThickness / 2, 0]}> 
          <boxGeometry args={[0.8, 0.15, 1.5]} />
        </mesh>
        <mesh material={chipMaterial} position={[1.2, PCBThickness / 2, 2.2]}> 
  ...
  return (
    <div className="w-full h-full min-h-[500px]">
      ...
      >
        ...
        <pointLight position={[-10, 5, 5]} intensity={1.5} color="#A3E635" />
