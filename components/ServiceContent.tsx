          ...
          return (
            ...
            >
              ...
              <div className="flex-1 relative min-h-[350px] overflow-hidden">
                <Image src={service.imageUrl} alt={service.title} fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 lg:p-10">
            ...
            >
              ...
              <div className="sticky top-0 z-50 flex justify-end p-6 pointer-events-none">
                <button 
                  onClick={() => setSelectedService(null)}
                  className="pointer-events-auto p-2 bg-white/80 backdrop-blur-md rounded-full shadow-lg border border-slate-200 hover:text-orange-600 transition-colors"
                >
                  <X size={24} />
                </button>
              </div>

              {/* Offset content so it doesn't hide behind sticky cross initially */}
              <div className="-mt-20">
