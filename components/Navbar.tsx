    ...
    <>
      ...
      >
        <nav className="container mx-auto max-w-7xl px-6 flex justify-between items-center">
          ...
          {/* MOBILE MENU BUTTON */}
          <button
            className={`md:hidden z-50 p-2.5 rounded-xl border transition-all duration-300 flex items-center justify-center ${
              isMobileMenuOpen
                ? "bg-slate-50 border-slate-200 text-slate-900 hover:text-orange-600"
                : "bg-white/90 backdrop-blur-md border-slate-200/80 text-slate-900 hover:text-orange-600 shadow-sm"
            }`}
